...
public class TrelloClientTest {
    ...
    public void init(){
        ...
        Mockito.when(trelloConfig.getTrelloUsername()).thenReturn("soran7");
    }
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/soran7/boards?key=test&token=test&fields=name,id&lists=all");
