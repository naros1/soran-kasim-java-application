...
public class TrelloFacadeTest {
    ...
    public void shouldFetchEmptyList(){
        ...
        Mockito.when(trelloMapper.mapToBoardsDto(Matchers.anyList())).thenReturn(new ArrayList<>());
    ...
    public void shouldFetchTrelloBoards(){
        ...
        Mockito.when(trelloService.fetchTrelloBoards()).thenReturn(trelloBoards);
        Mockito.when(trelloMapper.mapToBoards(trelloBoards)).thenReturn(mappedTrelloBoards);
        Mockito.when(trelloMapper.mapToBoardsDto(Matchers.anyList())).thenReturn(trelloBoards);
